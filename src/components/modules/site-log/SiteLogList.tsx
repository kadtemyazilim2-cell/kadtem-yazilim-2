    ...
    return (
        <div className="space-y-6">
            ...
            <Dialog open={isPreviewOpen} onOpenChange={setIsPreviewOpen}>
                <DialogContent className="preview-dialog !block max-w-none w-full !max-w-none h-[100dvh] p-0 border-none bg-white shadow-none fixed inset-0 z-[200] !translate-x-0 !translate-y-0 left-0 top-0 overflow-hidden m-0">
