...
import { ArrowRight, FileSpreadsheet, FileDown, ChevronDown, ChevronUp } from 'lucide-react';
                        ...
                        <TableBody>
                            {displayPurchases.length === 0 ? (
                                ...
                                displayPurchases.map((t: any) => (
                                    <TableRow
                                        key={t.id}
                                        className={canEdit ? "cursor-pointer hover:bg-slate-50 transition-colors" : "cursor-default opacity-90"} // [UPDATED] - Logic check
                                        onClick={() => {
                                            if (canEdit) { // [UPDATED] - Logic check
